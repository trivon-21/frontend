...
import { MgrAnalyticsServiceComponent } from './mgr-analytics-service.component';

describe('MgrAnalyticsServiceComponent', () => {
  let component: MgrAnalyticsServiceComponent;

  beforeEach(() => {
    component = new MgrAnalyticsServiceComponent();
  });
